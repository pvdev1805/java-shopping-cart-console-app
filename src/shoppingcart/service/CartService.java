...
import shoppingcart.service.interfaces.CartHandler;
import shoppingcart.service.interfaces.CheckoutHandler;
...
public class CartService implements CartHandler, CheckoutHandler {
	@Override
	public void addToCart(Product product, int quantity) {
		CartItem item = findProduct(product);
